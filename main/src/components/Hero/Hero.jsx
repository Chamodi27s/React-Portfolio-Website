...
import "./Hero.css";
import bgImg from "../assets/7.avif";
    ...
    >
      <section className="hero-section">
        <div className="hero-text">
          ...
          <p>
            I design and build user-friendly, creative, and intelligent
            applications using modern tools & technologies.
          </p>
          ...
          <div className="hero-buttons">
            ...
            <a
              href={CV}
              download="Chamodi_Sandeepani_CV.pdf"
        ...
        <div className="hero-image-container">
          <img src={profile} alt="Chamodi" className="hero-image" />
        </div>
      </section>
    </div>
  );
